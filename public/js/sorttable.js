...
jQuery.fn.addSortWidget = function(options){
    ...
    // column with counter of rows (1,2,3...) after sorting is shuffled 
    // this function keeps counter in order
    var renumberRows = function($dest, colNum){ // func takes a number of column with a counter
